...
import static QuizApplicationPackage.User.accountsFile;
...
public class CreateAccount extends javax.swing.JFrame {
    ...
    private boolean administratorNonexistent() {
        ...
        try (BufferedReader reader = Files.newBufferedReader(accountsFile)) {
            ...
            while (User.exists(account = loadNext(reader))) {
                ...
                if (account.getRole() == User.Role.ADMINISTRATOR) return false;
            }
            
            /*
                Because loadNext will only return null if end of file reached,
