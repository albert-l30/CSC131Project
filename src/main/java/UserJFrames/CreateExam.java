...
public class CreateExam extends javax.swing.JFrame {
    ...
    private void nextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextButtonActionPerformed
        ...
        try (BufferedWriter overwrite = Files.newBufferedWriter(quizFolder.resolve("questions.log"), StandardOpenOption.CREATE, StandardOpenOption.WRITE);
            ...
            overwrite.write((++numQuestions).toString());
            overwrite.newLine();
            overwrite.flush();                                            // Makes sure all data written to overwriteWriter's buffer is put in the file, before the appendWriter begins writing data
