...
public class CreateAccount extends javax.swing.JFrame {
    ...
    private void createAccountButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAccountButtonActionPerformed
        ...
        Path usersFolder = null;
        
        try {
        
            usersFolder = Paths.get(System.getProperty("user.home"), "QuizApplication", "Users");
        ...
        try {
            ...
            if (accountNameTaken(usersFolder.resolve("passwords.log"), accountTextField.getText())) {
        ...
        if (administratorCheckBox.isSelected()) {
            ...
            try (BufferedWriter writer = Files.newBufferedWriter(usersFolder.resolve("administrator.log"))) {
        ...
        try (BufferedWriter writer = Files.newBufferedWriter(usersFolder.resolve("passwords.log"), StandardOpenOption.CREATE, StandardOpenOption.APPEND)) {
